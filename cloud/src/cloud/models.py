"""Cloud wire and plaintext data models."""
...
class Observation(BaseModel):
    """Validated weather observation stored by Cloud."""
    ...
    def validate_cross_fields(self) -> Observation:
        """Validate stable identity and temperature ordering."""
...
class CloudEnvelope(BaseModel):
    """Bounded ML-KEM/AES-GCM envelope received from Gateway."""

    model_config = ConfigDict(extra="forbid")

    version: Literal[1]
    gateway_id: str = Field(pattern=IDENTIFIER)
    kem: Literal["ML-KEM-768"]
